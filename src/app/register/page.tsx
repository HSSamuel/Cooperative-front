  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-[#1b5e3a]/20">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/4 w-72 h-72 rounded-full bg-blue-400/5 blur-3xl"></div>
      </div>
          ...
          <form className="space-y-3 sm:space-y-4" onSubmit={handleRegister}>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    // ULTRA-SLIM HEIGHT: py-2 sm:py-2.5
                    className="appearance-none block w-full px-4 py-2 sm:py-2.5 border border-white/40 rounded-xl shadow-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#1b5e3a]/30 focus:border-[#1b5e3a] text-sm sm:text-base transition duration-200 bg-white/40 focus:bg-white/90"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  // ULTRA-SLIM HEIGHT: py-2 sm:py-2.5 (with pr-12 for the eye icon)
                  className="appearance-none block w-full pl-4 pr-12 py-2 sm:py-2.5 border border-white/40 rounded-xl shadow-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#1b5e3a]/30 focus:border-[#1b5e3a] text-sm sm:text-base transition duration-200 bg-white/40 focus:bg-white/90"
                />
                <button
                  type="button"
            ...
            <div className="pt-3">
              <button
                type="submit"
                disabled={isLoading}
                // ULTRA-SLIM HEIGHT: py-2 sm:py-2.5 to match the inputs perfectly
