...
export default function LoansPage() {
  ...
  const getGuarantorStatus = (guarantorStatus: string) => {
    ...
    return (
      <span className="text-amber-500 font-bold text-[10px] uppercase animate-pulse">
        Pending
      </span>
    );
  };
  ...
  if (status === "loading" || status === "idle") {
    return (
      <div className="animate-pulse flex flex-col gap-6 h-[800px] w-full">
        ...
        <div className="h-64 bg-slate-200 rounded-sm w-full"></div>
      ...
      <div className="flex flex-col gap-6 w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-sm p-6 shadow-sm border-l-4 border-[#1b5e3a] relative overflow-hidden group">
            ...
            <div className="flex items-baseline gap-1 relative z-10">
              <span className="text-xl font-bold text-slate-400">₦</span>
              <h3 className="text-3xl font-extrabold text-[#1b5e3a] tracking-tight truncate">
          ...
          <div className="bg-white rounded-sm p-6 shadow-sm border-l-4 border-red-500 relative overflow-hidden group">
            ...
            <div className="flex items-baseline gap-1 relative z-10">
              ...
              <h3 className="text-3xl font-extrabold text-red-600 tracking-tight truncate">
        ...
        {activeLoans.length > 0 && (
          <div className="flex flex-col gap-6">
            {activeLoans.map((loan: any) => {
              ...
              const monthlyKobo = totalDueKobo / 10;
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 sm:gap-y-8 gap-x-4 sm:gap-x-6 p-4 sm:p-6 md:p-8 bg-slate-50/50 border-b border-slate-100">
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs sm:text-base font-bold text-slate-800 mt-0.5 truncate">
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5"
                          fill="none"
                          viewBox="0 0 24 24"
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5"
                          fill="none"
                          viewBox="0 0 24 24"
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-red-100 text-red-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5"
                          fill="none"
                          viewBox="0 0 24 24"
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs sm:text-base font-bold text-red-500 mt-0.5 truncate">
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5"
                          fill="none"
                          viewBox="0 0 24 24"
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-xs sm:text-sm md:text-base font-bold text-slate-800 mt-0.5 truncate">
                          {startDate.toLocaleDateString("en-GB", dateOptions)}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 min-w-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        <svg
                          className="w-4 h-4 sm:w-5 sm:h-5"
                          fill="none"
                          viewBox="0 0 24 24"
                  ...
                  <div className="p-5 md:p-8 bg-white">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-3 gap-3">
                      <div>
                        <h4 className="font-bold text-slate-800 uppercase tracking-wide text-xs sm:text-sm">
                          Repayment Progress
                        </h4>
                      </div>
                      <div className="flex items-center gap-4 w-full sm:w-auto">
                        <span className="text-xl sm:text-2xl font-black text-[#1b5e3a]">
                          {progress}%
                        </span>
                    ...
                    <div className="w-full bg-slate-200 rounded-full h-3.5 mb-5 overflow-hidden shadow-inner">
                      <div
                    ...
                    <div className="flex justify-between items-center text-sm">
                      <div>
                        <p className="text-slate-500 text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-0.5">
                          Repaid So Far
                        </p>
                        <p className="font-black text-[#1b5e3a] text-base sm:text-lg">
                      ...
                      <div className="text-right">
                        ...
                        <p className="font-black text-red-500 text-base sm:text-lg">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4">
          <div className="bg-white rounded-sm shadow-xl w-full max-w-sm overflow-hidden animate-fade-in-up">
            <div className="flex justify-between items-center p-4 border-b border-slate-100 bg-slate-50">
              <h3 className="font-bold text-slate-800">Make Repayment</h3>
              <button
            ...
            <form onSubmit={handleRepayment} className="p-6 space-y-4">
              <div className="bg-emerald-50 text-emerald-800 text-xs p-3 rounded-sm border border-emerald-100 mb-4">
                Available Savings Balance:{" "}
                <strong className="font-black text-[#1b5e3a]">
