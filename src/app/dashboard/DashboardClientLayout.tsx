      ...
      >
        ...
        <nav className="flex-1 pb-6 space-y-1 overflow-y-auto custom-scrollbar">
          ...
          <button
            ...
            className="flex items-center justify-start gap-4 w-full px-6 py-3.5 transition-all duration-200 border-l-4 border-transparent text-emerald-100/70 hover:bg-white/10 hover:text-white font-medium mt-auto disabled:opacity-50"
          >
            {isLoggingOut ? (
              <svg
                className="animate-spin w-5 h-5 flex-shrink-0 text-emerald-300/50"
